...
exports.verify = exports.sign = exports.combined = exports.asymmetric = exports.symmetric = void 0;
...
function makeSecureWebhooks(getSigner, getVerifier) {
    return {
        ...
        verify(input, secret, signature, opts = {}) {
            ...
            const timestamp = (_a = opts === null || opts === void 0 ? void 0 : opts.timestamp) !== null && _a !== void 0 ? _a : Date.now();
            const timeout = (_b = opts === null || opts === void 0 ? void 0 : opts.timeout) !== null && _b !== void 0 ? _b : FIVE_MINUTES;
...
exports.symmetric = makeSecureWebhooks(secret => input => (0, crypto_1.createHmac)('sha256', secret)
    .update(input)
    .digest('hex'), secret => (input, digest) => (0, crypto_1.createHmac)('sha256', secret)
    .update(input)
    .digest('hex') === digest);
exports.asymmetric = makeSecureWebhooks(priv => input => (0, crypto_1.createSign)('sha256')
    .update(input)
    .sign(priv, 'base64'), pub => (input, digest) => (0, crypto_1.createVerify)('sha256')
    .update(input)
...
exports.sign = exports.symmetric.sign;
exports.verify = exports.symmetric.verify;
//# sourceMappingURL=secureWebhooks.js.map