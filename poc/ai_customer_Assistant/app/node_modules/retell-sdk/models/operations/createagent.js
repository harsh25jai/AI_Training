...
(function (CreateAgentRequestBody$) {
    CreateAgentRequestBody$.inboundSchema = zod_1.z
        ...
        opt_out_sensitive_data_storage: zod_1.z.boolean().optional(),
        format_text: zod_1.z.boolean().optional(),
        language: zod_1.z.nativeEnum(components_1.Language).optional(),
    })
        .transform((v) => {
        return {
    ...
    CreateAgentRequestBody$.outboundSchema = zod_1.z
        ...
        llmWebsocketUrl: zod_1.z.string(),
        ...
        optOutSensitiveDataStorage: zod_1.z.boolean().optional(),
        formatText: zod_1.z.boolean().optional(),
        language: zod_1.z.nativeEnum(components_1.Language).optional(),
    })
        .transform((v) => {
        return {
...
(function (CreateAgentResponse$) {
    CreateAgentResponse$.inboundSchema = zod_1.z
        .object({
    ...
    CreateAgentResponse$.outboundSchema = zod_1.z
        .object({
...
})(CreateAgentResponse$ || (exports.CreateAgentResponse$ = CreateAgentResponse$ = {}));
